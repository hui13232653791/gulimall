...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void saveSpuInfo(SpuSaveVo vo) {
        ...
        List<String> decript = vo.getImages();
        ...
        //5、保存Spu的积分等信息；gulimall_sms：sms_spu_bounds
        ...
        if (skus != null && skus.size() > 0) {
            skus.forEach(item -> {
                ...
                */
                ...
                //6、3）保存Sku的优惠、满减等信息；gulimall_sms：sms_sku_ladder、sms_sku_full_reduction、sms_member_price
    ...
    public PageUtils queryPageByCondition(Map<String, Object> params) {
        ...
        String catelogId = (String) params.get("cateloogId");
